...
|---|---|---|---|
| 1 | **Luma Scribe** (in-visit digital scribe — physician can turn it on/off per encounter) | Listens to the encounter, drafts the note, **suggests questions**, and pre-drafts **ICD-10 + CPT** codes for sign-off. Charting happens *between* patients, not at day's end — no homework. | **P0** |
...
| # | Feature | What it does | Priority |
|---|---|---|---|
| 10 | **Scribe auto-coding → claim** | Luma Scribe's drafted **diagnosis + billing codes** flow straight into the existing Encounter & Claim workflow for one-tap verification. Ties Pillar 1 to the revenue cycle. | **P0** |
...
1. **P0 wave:** Focus/Lean mode · Luma Scribe (note + questions + codes → claim) · Batched inbox · Unified care timeline · Chart Scrub.
